...
public class Response<T> {
    ...
    private Response(boolean success, String code, String message, T result) {
    ...
    private Response(boolean success, ResponseEnum responseEnum, T result) {
        this.success = success;
    ...
    public static Response success() {
        return new Response(true, ResponseEnum.SUCCESS, null);
    }
    ...
    public static Response success(String message) {
        ...
        return new Response(true, ResponseEnum.SUCCESS.getCode(), message, null);
    }
    ...
    public static <T> Response<T> success(T result) {
        return new Response(true, ResponseEnum.SUCCESS, result);
    }
    ...
    public static <T> Response<T> success(T result, String message) {
        message = StringUtils.isEmpty(message) ? ResponseEnum.SUCCESS.getMessage() : message;
        return new Response(true, ResponseEnum.SUCCESS.getCode(), message, result);
    }
     ...
     * @return
     */
    public static Response busiFailed(){
        return new Response(true, ResponseEnum.BUSI_FAILED_USER_UNKNOWN.getCode(), ResponseEnum.BUSI_FAILED_USER_UNKNOWN.getMessage(), null);
    }
     ...
     * @return
     */
    public static Response busiFailed(String code, String message){
     ...
     * @return
     */
    public static <T> Response<T> busiFailed(T result, String code, String message){
        code = StringUtils.isEmpty(code) ? ResponseEnum.BUSI_FAILED_USER_UNKNOWN.getCode() : code;
        message = StringUtils.isEmpty(message) ? ResponseEnum.BUSI_FAILED_USER_UNKNOWN.getMessage() : message;
        return new Response(true, code, message, result);
    }
    ...
    public static Response failed() {
        return new Response(false, ResponseEnum.ERROR_UNKNOWN, null);
    }
     ...
     * @return
     */
    public static Response failed(ResponseEnum responseEnum) {
        responseEnum = Optional.ofNullable(responseEnum).orElse(ResponseEnum.ERROR_UNKNOWN);
        return new Response(false, responseEnum, null);
    }
     ...
     * @return
     */
    public static Response failed(ResponseEnum responseEnum, String message) {
        responseEnum = Optional.ofNullable(responseEnum).orElse(ResponseEnum.ERROR_UNKNOWN);
        message = StringUtils.isEmpty(message) ? ResponseEnum.ERROR_UNKNOWN.getMessage() : message;

        return new Response(false, responseEnum.getCode(), message, null);
    }
